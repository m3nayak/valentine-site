...
(function softLuxeHeartsOnly(){
  ...
  const COUNT = 200;         // subtle density
...
(function lipstickKissPopups(){
  ...
  const MIN_MS = 900;       // minimum time between spawns
  const MAX_MS = 1700;       // maximum time between spawns
  ...
  function spawn(){
    ...
    const dur = Math.round(rand(5200, 9000)); // ms
